...
psychoJS.start({
  ...
  resources: [
    // resources:
    {'name': 'Resource/HardMode/riddles.xlsx', 'path': 'Resource/HardMode/riddles.xlsx'},
    {'name': 'Resource/HardMode/no.7.png', 'path': 'Resource/HardMode/no.7.png'},
    {'name': 'Resource/HardMode/success.mp3', 'path': 'Resource/HardMode/success.mp3'},
    {'name': 'Resource/HardMode/no.8.png', 'path': 'Resource/HardMode/no.8.png'},
    {'name': 'Resource/HardMode/mistake.mp3', 'path': 'Resource/HardMode/mistake.mp3'},
    {'name': 'Resource/HardMode/no.9.png', 'path': 'Resource/HardMode/no.9.png'},
    {'name': 'Resource/HardMode/no.10.png', 'path': 'Resource/HardMode/no.10.png'},
    {'name': 'Resource/HardMode/no.11.png', 'path': 'Resource/HardMode/no.11.png'},
    {'name': 'Resource/HardMode/test.xlsx', 'path': 'Resource/HardMode/test.xlsx'},
    {'name': 'Resource/HardMode/no.6.png', 'path': 'Resource/HardMode/no.6.png'},
...
function trialsLoopBegin(trialsLoopScheduler, snapshot) {
  return async function() {
    ...
    trials = new TrialHandler({
      ...
      extraInfo: expInfo, originPath: undefined,
      trialList: 'Resource/HardMode/riddles.xlsx',
...
function trials_2LoopBegin(trials_2LoopScheduler, snapshot) {
  return async function() {
    ...
    trials_2 = new TrialHandler({
      ...
      nReps: 1, method: TrialHandler.Method.SEQUENTIAL,
      extraInfo: expInfo, originPath: undefined,
      trialList: 'Resource/HardMode/test.xlsx',
...
function FeedbackRoutineBegin(snapshot) {
  return async function () {
    ...
    let correctSound = new Audio("Resource/HardMode/success.mp3");
    let incorrectSound = new Audio("Resource/HardMode/mistake.mp3");
...
function SaveRoutineBegin(snapshot) {
  return async function () {
    ...
    fetch("https://pipe.jspsych.org/api/data", {
        ...
        body: JSON.stringify({
            experimentID: "E3BaB2Tv0aTH",   // replace with your DataPipe experiment ID
